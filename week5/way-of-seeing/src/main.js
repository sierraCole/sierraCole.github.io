...
//Load models
loader.load( 'src/models/BG-LB Pose.glb', function (gltf) {
...
loader.load( 'src/models/BG-Drama Pose.glb', function (gltf){
    const model = gltf.scene;
  model.position.set(4, 0, -4);
...
loader.load( 'src/models/BG-Lay Pose.glb', function (gltf) {
   const model = gltf.scene;
